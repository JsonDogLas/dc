...
(function ($) {
    ...
    $.fn.colorpicker = function (options) {
        ...
        function initColor() {
            $("body").append('<div id="colorpanel" style="position: absolute; display: none;width:220px;"></div>');
            var colorTable = '';
            var colorValue = '';
            for (i = 0; i < 2; i++) {
                for (j = 0; j < 6; j++) {
            ...
            colorTable = '<table width=100% border="0" cellspacing="0" cellpadding="0" style="border:1px solid #000;">'
