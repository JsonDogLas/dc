...
public interface FileManager {
    ...
    String uploadFile(@RequestPart("file") MultipartFile file, @RequestParam(name = "signId",required = false) String signId);
    ...
    String deleteFile(@PathVariable("id") String id);
